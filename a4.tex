...
\midrule
SFT (baseline) & Default SFT mixture & 0.4758 & ChatCORE 0.2111; MMLU 30.41\%; ARC-E 32.79\%; ARC-C 28.67\% \\
SFT (SmolTalk2) & SmolTalk2-enhanced & -- & TBD \\
Midtraining (baseline) & Default pretrain data & -- & TBD \\
Midtraining (SmolTalk2) & SmolTalk2-derived & -- & TBD \\
\bottomrule
\end{tabular}
...
The baseline SFT run converged in just over one epoch (step 1003), with minimum validation BPB of 0.4758 and ChatCORE 0.2111 (ChatCORE\_cat 0.0750). Task breakdown at the final evaluation: ARC-Easy 32.79\%, ARC-Challenge 28.67\%, MMLU 30.41\%, GSM8K 0\%, HumanEval 4.17\%, and SpellingBee 100\%. Total training time was 50.69 minutes.
